...
## [4.4.31] - 2021-09-14
### Update and Fixed
- Update products values exhibition for promotionals prices and fix some layouts screen on summary and product details.
...
## [3.37.2] - 2020-07-30
### Fixed
- Active **background** `action-secondary` color from `#ffe1e9` to `#d2defc`
- Active **border** `action-secondary` color from `#ffe1e9` to `#d2defc`
